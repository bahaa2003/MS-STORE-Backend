...
describe('calculateFinalPrice — pure function', () => {
    ...
    it('preserves decimal precision for stored product prices', () => {
    ...
    it('accepts decimal string basePrice', () => {
    ...
    it('accepts decimal string percentage and rejects missing percentage', () => {
        expect(calculateFinalPrice(100, '10')).toBe('110');
